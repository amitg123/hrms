              ...
              <tr>
                ...
                <td>
                  <?php if(!empty($salary_payments)): ?>
                    ...
                    <?php else: ?>
                      <a href="<?php echo e(url('hrm/salary-payments/manage-salary/' . $employee['user_id'] . '/' . $salary_month)); ?>"><p class="text-danger"><?php echo e(__('Make payment')); ?></p></a>
                    <?php endif; ?>
                  <?php else: ?>
                    <a href="<?php echo e(url('hrm/salary-payments/manage-salary/' . $employee['user_id'] . '/' . $salary_month)); ?>"><p class="text-danger"><?php echo e(__('Make payment')); ?></p></a>
                  <?php endif; ?>
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Environment\PHP\laragon\www\inhouse\hrms\resources\views/administrator/hrm/salary_payment/employees_salary_list.blade.php ENDPATH**/ ?>